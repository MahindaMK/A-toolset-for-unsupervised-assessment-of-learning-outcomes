...
map1=xlsread('Group11_beg.xlsx','Map-01','J9:AX49');
map2=xlsread('Group11_beg.xlsx','Map-02','J9:AX49');
map3=xlsread('Group11_beg.xlsx','Map-03','J9:AX49');

% load the concepts used in each map
P1=xlsread('Group11_beg.xlsx','Map-01','H9:H20');
P2=xlsread('Group11_beg.xlsx','Map-01','G9:G20');
P3=xlsread('Group11_beg.xlsx','Map-01','F9:F20');

% load the group average map and used concepts
Pka=xlsread('Group11_beg.xlsx','Average','A9:A24');
mapka=xlsread('Group11_beg.xlsx','Average','J9:AX49');
...
writematrix(D12,'DR_group11_beg.xlsx','Range','C3:I3');    % Langfield-Smith and Wirths formula 12
writematrix(D12A2,'DR_group11_beg.xlsx','Range','C4:I4');  % Generalization 2 of Langfield-Smith and Wirths formula 12. Takes intoa account the areas of the maps. (d(x,y)=1 can not be exceeded)
