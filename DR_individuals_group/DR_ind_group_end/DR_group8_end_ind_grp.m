...
map1=xlsread('Group8_end.xlsx','2_1','J9:AX49');
map2=xlsread('Group8_end.xlsx','2_2','J9:AX49');
map3=xlsread('Group8_end.xlsx','2_3','J9:AX49');
map4=xlsread('Group8_end.xlsx','2_4','J9:AX49');
map5=xlsread('Group8_end.xlsx','2_5','J9:AX49');

% load the concepts used in each map
P1=xlsread('Group8_end.xlsx','2_1','H9:H20');
P2=xlsread('Group8_end.xlsx','2_1','G9:G20');
P3=xlsread('Group8_end.xlsx','2_1','F9:F20');
P4=xlsread('Group8_end.xlsx','2_1','E9:E20');
P5=xlsread('Group8_end.xlsx','2_1','D9:D20');

% load the group average map and used concepts
Pka=xlsread('Group8_end.xlsx','Average','A9:A24');
mapka=xlsread('Group8_end.xlsx','Average','J9:AX49');
...
writematrix(D12,'DR_group8_end.xlsx','Range','C3:I3');    % Langfield-Smith and Wirths formula 12
writematrix(D12A2,'DR_group8_end.xlsx','Range','C4:I4');  % Generalization 2 of Langfield-Smith and Wirths formula 12. Takes intoa account the areas of the maps. (d(x,y)=1 can not be exceeded)
